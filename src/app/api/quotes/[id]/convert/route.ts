  ...
  try {
    ...
    const order = await prisma.order.create({
      data: {
        ...
        taxParcelId: quote.taxParcelId || null,
        acres: quote.acres || null,
        primaryOwner: quote.primaryOwner || null,
        propertyClass: quote.propertyClass || null,
        satelliteImagePath: quote.satelliteImagePath || null,
