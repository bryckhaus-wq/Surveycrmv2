  ...
  try {
    ...
    const updated = await prisma.quote.update({
      ...
      data: {
        ...
        ...(parcelId !== undefined && { parcelId: parcelId ? parcelId.trim() : null }),
        ...(taxParcelId !== undefined && { taxParcelId: taxParcelId ? taxParcelId.trim() : null }),
        ...(deedAcres !== undefined && { deedAcres: deedAcres !== null ? parseFloat(deedAcres) : null }),
        ...
        ...(complicatingFactors !== undefined && { complicatingFactors }),
        ...(latitude !== undefined && {
